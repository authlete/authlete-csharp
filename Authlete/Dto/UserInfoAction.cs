...
namespace Authlete.Dto
{
    ...
    public enum UserInfoAction
    {
        ...
        /// <a href="http://openid.net/specs/openid-connect-core-1_0.html#UserInfo">userinfo
        /// endpoint</a> implementation should collect information
        /// about requested claims and pass the information to
        /// Authlete's <c>/api/auth/userinfo/issue</c> API in order
        /// to make Authlete generate a userinfo response.
        /// </summary>
        OK,
    }
}
