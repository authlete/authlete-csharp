...
{
    /// <summary>
    /// Request to Authlete's <c>/api/device/authorization</c> API.
    /// </summary>
    ///
    /// <remarks>
    /// <para>
    /// When the implementation of the device authorization endpoint
    /// of the authorization server receives a device authorization
    /// request from a client application, the first step is to call
    /// Authlete's <c>/api/device/authorization</c> API. The API will
    /// parse the device authorization request on behalf of the
    ...
    {
        /// <summary>
        /// Device authorization request parameters which the device
        ...
        /// header of a device authorization request from a client
        /// application.
        /// </summary>
        ///
        /// <remarks>
        /// <para>
        /// If the device authorization endpoint of the authorization
        /// server supports Basic Authentication as a means of
        ...
        /// header of the device authorization request from the client
        /// application.
        /// </summary>
        ///
        /// <remarks>
        ...
        /// between the client application and the device
        /// authorization endpoint of the authorization server.
        /// </summary>
