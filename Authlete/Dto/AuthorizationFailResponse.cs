...
{
    /// <summary>
    /// Response from Authlete's <c>/api/auth/authorization/fail</c>
    /// API.
    /// </summary>
    ///
    /// <remarks>
    /// <para>
    /// Authlete's <c>/api/auth/authorization/fail</c> API returns
    ...
    /// <c>AuthorizationFailAction.INTERNAL_SERVER_ERROR</c>,
    ...
    /// <para>
    /// When the value of the <c>Action</c> property is
    /// <c>AuthorizationFailAction.BAD_REQUEST</c>, it means that
    ...
    /// <para>
    /// When the value of the <c>Action</c> property is
    /// <c>AuthorizationFailAction.LOCATION</c>, it means that the
    ...
    /// to which the error should be reported, so it can be used as
    /// the value of <c>"Location"</c> header. The following
    /// illustrates the response which the authorization server
    ...
    /// <para>
    /// When the value of the <c>Action</c> property is
    /// <c>AuthorizationFailAction.FORM</c>, it means that the
    ...
    /// </code>
    /// </remarks>
    public class AuthorizationFailResponse : ApiResponse
    {
        /// <summary>
        ...
        public AuthorizationFailAction Action { get; set; }
